...
const chatContainer = document.querySelector('#load_container')
...
const handleSubmit = async (e) => {
    ...
    if (response.ok) {
        ...
        const parsedData = data.kuwarp.trim() // trims any trailing spaces/'\n' 

        typeText(messageDiv, parsedData)
    } else {
        const err = await response.text()

        messageDiv.innerHTML = "I think you need to try something new";
        alert(err)
    }
}
